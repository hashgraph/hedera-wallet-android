...
public class Reference {
	...
	private byte[] data;
	private static final @NonNull String digits = "0123456789"
	 ...
	 */
	public Reference(@NonNull byte[] data) {
		if (data == null) {
	 ...
	 */
	@NonNull
	static String toHex(@NonNull byte[] bytes, int firstIndex, int lastIndex) {
		String ans = "";
