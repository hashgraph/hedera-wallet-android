/**
* Parts of this code is adopted from the below repository
* src/main/java/com/ripple/crypto/ecdsa/EDKeyPair.java
* at github repo
* https://github.com/ripple-unmaintained/ripple-lib-java/blob/master/LICENSE
*/
