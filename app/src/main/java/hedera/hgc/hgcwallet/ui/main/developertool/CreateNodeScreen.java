        ...
        mButtonsave.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!mEditTextAccountId.getText().toString().isEmpty()) {
                    HGCAccountID accountID = HGCAccountID.Companion.fromString(mEditTextAccountId.getText().toString());
                    if (accountID != null) {
                ...
                if (paramNode == null) {
                    DBHelper.INSTANCE.createNode(node);

                } else {
                    DBHelper.INSTANCE.updateNode(node);
