/*
* This code is an adaptation of sonusurender OpenSource project codebase
* Attributed to Apache 2.0 License
* https://github.com/sonusurender/Security_Lock_Demo
* app/src/main/java/com/security_lock_demo/MainActivity.java
*/
...
public abstract class AuthActivity extends AppCompatActivity implements AuthListener {
    ...
    public void requestAuth(int requestCode ) {
        ...
        switch (authManager.getAuthType()) {
            case PIN:
                ...
                intent.putExtra(PinAuthActivity.Companion.getEXTRA_TYPE(), PinAuthActivity.Companion.getTYPE_UNLOCK());
    ...
    public void setupAuth(AuthType authType) {
        ...
        switch (authType) {
            case PIN:
                Intent intent = new Intent(this, PinAuthActivity.class);
                intent.putExtra(PinAuthActivity.Companion.getEXTRA_TYPE(), PinAuthActivity.Companion.getTYPE_ENABLE());
