...
import hedera.hgc.hgcwallet.ui.main.developertool.WebCommunicationScreen
...
class ExportKeyActivity : BaseActivity(), AccountListScreen.AccountPickerListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        actionBartitle?.text = resources.getString(R.string.menuItem_export_key)
    }
    ...
    override fun onAccountPick(account: Account?) {
        ...
        IntentIntegrator(this)
                ...
                .setPrompt(App.instance.getString(R.string.export_key_share_warning))
                .initiateScan()
    }
